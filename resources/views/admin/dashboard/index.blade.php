                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Menunggu pembayaran
                                </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-info shadow h-100 py-2">
                    <div class=" card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold  text-uppercase mb-1 text-info">Payment
                                    Success
                                </div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $paymentSuccess }}</div>
                            </div>
                            <div class="col-auto">
                                <i class="fas fa-check-circle  fa-spin  fa-2x text-info"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-secondary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Barang diproses
                                </div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $process }}</div>
                            </div>
                            <div class="col-auto">
                                <i class="fas fa-sync fa-spin text-secondary  fa-2x"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-warning shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Barang dikirim
                                </div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $shipping }}</div>
                            </div>
                            <div class="col-auto">
                                <i class="fas fa-truck fa-spin text-warning fa-2x"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold ">Bar Chart Penjualan Setiap Bulan</h6>
                    </div>
                    <div class="card-body">
                        <div class="chart-bar">
        ...
        var myLineChart = new Chart(ctx, {
            ...
            options: {
                ...
                tooltips: {
                    ...
                    bodyFontColor: "#2e2f3e",
                    titleMarginBottom: 15,
                    titleFontColor: '#0f0e17',
                    titleFontSize: 14,
                    borderColor: '#dddfeb',
                    borderWidth: 1,
                    xPadding: 15,
