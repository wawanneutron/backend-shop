  ...
  <div style="background-color:#e4e6eb;">
    ...
    <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;">
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#ffffff;background-color:#ffffff;width:100%;">
        ...
        <mj-image src="images/logo.png" alt="" align="center" width="180px" border="none" padding-left="0px" padding-right="0px" padding-bottom="25px" padding-top="30px">
      </mj-column> -->
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:30px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Playfair Display, Times New Roman, serif;font-size:30px;font-weight:bold;line-height:1;text-align:center;color:#071c4d;">Terimakasih Sudah Chackout</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
                          ...
                          <tbody>
                            <tr>
                              <td style="width:550px;">
                                <img alt="" height="auto" src="{{ asset('assets/img/email/header.jpg') }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="550" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                      ...
                      <td style="border-bottom:1px dashed #eee;vertical-align:middle;padding-bottom:30px;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:20px;text-align:left;color:#071c4d;">
                                  Hi, {{ $data_transaction->name }}  <br><br> Ini adalah Invoice pesanan kamu yang harus anda bayarkan.</div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071c4d;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                  <tr>
                                    ...
                                    <td style="text-align: right; font-weight:500;"> {{ $data_transaction->invoice }}
                                  </tr>
                                  <tr>
                                    <td><strong>Total</strong></td>
                                    <td style="text-align: right; font-weight:500;">{{ moneyFormat($data_transaction->grand_total)  }}
                                  </tr>
                                </table>
                              </td>
                            </tr>
                                  ...
                                  <tr>
                                    ...
                                    @foreach ($data_transaction->orders as $item)
                                      <tr>
                                        ...
                                        <td style="text-align: right; font-weight:500;">{{ $item->qty }} pcs
                                      </tr>
                                    @endforeach
                                </table>
                              </td>
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:20px;text-align:left;color:#071c4d;">Verifikasi akan dilakukan otomatis oleh sistem.</div>
                              </td>
                            </tr>
                            <tr>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td align="center" bgcolor="#E87B17" role="presentation" style="border:none;border-radius:10px;cursor:auto;mso-padding-alt:10px 25px;background:#E87B17;" valign="middle">
                                        <a href="http://localhost:8080/customer/order/{{ $data_transaction->snap_token }}" style="display:inline-block;background:#E87B17;color:#ffffff;font-family:Assistant, Helvetica, Arial, sanf-serif;font-size:18px;font-weight:400;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;"> Check Detail </a>
                                      </td>
                                    </tr>
                                </tbody>
                              </table>
              ...
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tbody>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;font-weight:600;line-height:20px;text-align:left;color:#071c4d;">Butuh Bantuan ?</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                          <tr>
                            <td style="width: 50px;">
                              <img src=" {{ asset('assets/img/email/ic_help.png' ) }} " width="50px">
                            </td>
                            <td style="font-size:18px; padding-left:10px; color:#071c4d; font-family:Assistant, Helvetica, Arial, sanf-serif; font-weight:600"> support@store-ecommerce <br> 021-2020-2022 </td>
                          </tr>
                        </table>
                      </td>
                    </tr>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Assistant, Helvetica, Arial, sanf-serif;font-size:15px;line-height:1;text-align:center;color:#888b93;">2021 Copyright Store Commerce - All right reserved.</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
